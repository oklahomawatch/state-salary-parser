...
EXTRA_EDU_AGENCIES = [{"id":"LU0","agency":"LANGSTON UNIVERSITY (RETIREE)"},{"id":"CSC","agency":"CONNORS STATE COLLEGE (RETIREE)"},{"id":"NEO","agency":"NORTHEASTERN OKLAHOMA (RETIREE)"},{"id":"CU0","agency":"CAMERON UNIVERSITY (RETIREE)"},{"id":"OSU","agency":"OSU (RETIREE)"},{"id":"OU0","agency":"OU (RETIREE)"},{"id":"PSU","agency":"PANHANDLE STATE UNIVERSITY (RETIREE)"},{"id":"607","agency":"ARDMORE HIGHER EDUCATION CENTER (RETIREE)"}]

EXTRA_PAYROLL_CODES = [{"id":"1130","paycode":"EDUCATION LOAN INCENTIVES"}]
